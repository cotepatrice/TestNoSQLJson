...
[![Nuget](https://img.shields.io/nuget/v/SoftwareAteliers.ClientWebApp.svg?style=flat&color=2196f3)](https://www.nuget.org/packages/SoftwareAteliers.ClientWebApp/)
...
* Install the template from NuGet repository: `dotnet new -i SoftwareAteliers.ClientWebApp`
